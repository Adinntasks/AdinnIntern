...
const projects = [
  {
    ...
    description: 'Our roadshow trucks are designed to take your brand directly to your audience. With vibrant display panels and eye-catching designs, they create instant visibility wherever they go. A perfect way to turn everyday spaces into powerful brand touchpoints.',
  ...
  return (
    <div ref={sectionRef}>
      ...
      <div className="projects-heading">
        <img 
          src="./images/ProjectsTitle.png" 
          alt="Projects" 
          className="projects-heading-img"
        />
      </div>

      {/* Click overlay to close active cards (Mobile) */}
      {activeId && (
        <div
